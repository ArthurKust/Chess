...
public class SecondActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public ArrayList<ArrayList<Coordinates>> WhiteDanger = new ArrayList<>();
    public ArrayList<ArrayList<Coordinates>> BlackDanger = new ArrayList<>();
        ...
        if (!AnythingSelected) {
            if (Board[clickedPosition.getX()][clickedPosition.getY()].getPiece() == null) {
                ...
                if (Board[clickedPosition.getX()][clickedPosition.getY()].getPiece().isWhite() != FirstPlayerTurn) {
                    ...
                    listOfCoordinates = Board[clickedPosition.getX()][clickedPosition.getY()].getPiece().RightMoves(clickedPosition, Board);
                    ...
                    if(Board[clickedPosition.getX()][clickedPosition.getY()].getPiece() instanceof King) {
                        if (Board[clickedPosition.getX()][clickedPosition.getY()].getPiece().isWhite()) {
                            listOfCoordinates.remove(BlackDanger);
                        } else {
                            listOfCoordinates.remove(WhiteDanger);
                        }
                    }
                    DisplayBoardBackground[clickedPosition.getX()][clickedPosition.getY()].setBackgroundResource(R.color.colorSelected);
                    setColorAtRightPosition(listOfCoordinates);
                    AnythingSelected = true;
                }
            }
        } else {
            if (Board[clickedPosition.getX()][clickedPosition.getY()].getPiece() == null) {
                if (moveIsRight(listOfCoordinates, clickedPosition)) {
                    ...
                    resetColorAtRightPosition(listOfCoordinates);
    ...
    private void resetColorAtRightPosition(ArrayList<Coordinates> listOfCoordinates) {
    ...
    void setColorAtRightPosition(ArrayList<Coordinates> list){
    ...
    private boolean moveIsRight(ArrayList<Coordinates> piece, Coordinates coordinate) {
        ...
        for(int i=0;i<8;i++){
            for(int j=0;j<8;j++){
                if(Board[i][j].getPiece() != null){
                    ...
                    List = Board[i][j].getPiece().RightMoves(c,Board);
            ...
            for (int j = 0; j < 8; j++) {
                if (Board[i][j] != null){
                    if (Board[i][j].getPiece().isWhite()) {
                        WhiteDanger.add(Board[i][j].getPiece().RightMoves(new Coordinates(i, j), Board));
                    } else {
                        BlackDanger.add(Board[i][j].getPiece().RightMoves(new Coordinates(i, j), Board));
                    }
                }
            }
        }
